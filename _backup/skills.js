// ==========================================================================
// INTERACTIVE REACT SKILLS COMPONENT - SOPHIA THOMPSON PORTFOLIO
// ==========================================================================
...
const SkillsComponent = () => {
    ...
    // Trigger visual progress animation upon mounting
    useEffect(() => {
    ...
    const handleCategoryChange = (category) => {
        ...
        // Automatically select first matching skill in category if available
    ...
    return (
        <React.Fragment>
            ...
            <div className="skills-search-wrapper">
                <svg className="skills-search-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
